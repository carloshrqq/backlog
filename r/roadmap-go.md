...
[Seção 3 da documentação do Go](https://go.dev/doc/tutorial/create-module)
...
não tenho prática com Go contudo entendi que a convenção do doc esta de acordo com o padrão que voce citou (linha 3 do seu comentário)
os links podem te ajudar melhor
...
https://www.golang.company/blog/golang-tutorial-the-complete-beginner-guide
