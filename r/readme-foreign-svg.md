#review 
# 1. Adding custom HTML and CSS to GitHub README
...
# 2. Custom CSS and HTML in an SVG
...
# 3. Render SVG inside GitHub README
...
## 3.1 Render local README Files before pushing to Github

To be sure everything is working properly before you push to GitHub, you can use a cool tool called `grip`. For more info visit [G.R.I.P - Github Readme Instant Preview](https://github.com/joeyespo/grip). The grip is a CLI tool written in Python and it uses the GitHub API to render your Markdown files. I installed it quickly with brew install grip and you can run it by just typing grip inside the repo with .md files and then pressing enter. It will then run a server with your Markdown files.
...
![Nikolalsvk](readme-nikolalsvk-github-profile.gif)

Here’s the link to my [Github profile repo](https://github.com/nikolalsvk/nikolalsvk) and the actual [SVG file](https://github.com/nikolalsvk/nikolalsvk/blob/main/welcome.svg?short_path=b0decb1) that is rendered there.
...
Duza, Nikola (13 de março de 2022). _[Adding custom html and CSS to GitHub Readme](https://pragmaticpineapple.com/adding-custom-html-and-css-to-github-readme/#:~:text=Here's%20the%20final%20version%20(pro,where%20we%20will%20learn%20that.)_. _[Pragmatic Pinneaple](https://pragmaticpineapple.com/)_. Repositorio [nikolalsvk](https://github.com/nikolalsvk). Consultado em 21 de março de 2025.
