...
How to install
[Convert academic papers from obsidian to Word/Latex/PDF using PANDOC PLUGIN](https://www.youtube.com/watch?v=OMPx1dCdcYA&t)
[Obsidian Pandoc Plugin](https://github.com/OliverBalfour/obsidian-pandoc?tab=readme-ov-file)
Press `Ctrl`+`P`
Search `"Pandoc"`

[Using Pandoc](https://www.youtube.com/watch?v=N31E_NZYQQY)
## Community plugins list

This plugin is now installable in the community plugins list. You must [install Pandoc](https://pandoc.org/installing.html) first if you have not already.
...
Windows:
`D:\R\Repositories\obsidian-vault-carlosfnt\.obsidian\plugins\obsidian-pandoc`
# 1. Título A
# 1. Título B
