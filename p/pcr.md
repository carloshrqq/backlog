...
quimioluminêscencia abbott 4a geração
==indetectável: menor ou igual a 40 cp/ml
...
vldr lues
==cicatriz sorologica: 
pos 3 meses 1/64 ou 1/32
pos 6 meses 1/32 ou 1/16
pos 9 meses 1/16 ou 1/8

==PCR quantitativo ou hivqt==
A técnica de PCR quantitativo (Polymerase Chain Reaction) é utilizada para detectar e quantificar o material genético do HIV na amostra de sangue
ma carga viral baixa ou indetectável (abaixo de 50 cópias/mL)

O PCR quantitativo para HIV mede a carga viral, ou seja, a quantidade de cópias do RNA do HIV-1 por mililitro de plasma. O valor de referência para este exame é geralmente considerado como "indetectável" abaixo de 50 cópias/mL. 

==Valores entre 20 e 1.000 cópias/mL indicam um risco quase nulo de transmissão sexual do HIV, enquanto valores acima de 1.000 cópias/mL representam um risco relevante.== 

![](Pasted%20image%2020250513163825.png)
# 1. Título B
