Um design system é um conjunto de padrões, regras e princípios que orientam o desenvolvimento de interfaces de uma empresa. Ele é um kit de ferramentas que ajuda a criar produtos digitais escaláveis e a manter a consistência. 
Características 
Unifica a linguagem de um produto
Facilita a comunicação entre equipes
Simplifica o trabalho de designers de produtos
Mantém a consistência e a identidade de marca
Componentes 
Diretrizes da marca
...
Documentação Deve ser clara e acessível, Deve ser técnica e conceitual, Pode ser apresentada em formatos como vídeos ou tutoriais, Deve ser colaborativa. 
Equipes 
Pode ser composta por uma única pessoa
Pode ser federada, com várias equipes contribuindo
Pode ser centralizada, com todas as responsabilidades concentradas em uma única equipe

![Stack overflow design system](Pasted%20image%2020250327083157.png)

![StackOverflow Design system - Using  Stacks](Pasted%20image%2020250327083221.png)

[Sobre Design System](https://en.wikipedia.org/wiki/Design_system)
# 1. Título A
# 1. Título B
